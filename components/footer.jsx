                    ...
                    <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul class="text-[#F2B90C] dark:text-[#F2B90C] font-medium">
                                ...
                                <li class="mb-4">
                                    <Link
                                        href="https://t.me/VPWRace_Peradox"
                                        target="_blank"
                                        class="hover:underline"
                                    >
                                        Telegram
                                ...
                                <li class="mb-4">
                                    <Link
                                        href="https://support.discord.com/hc/en-us/profiles/13617368169623-Virtualperadox"
                                        target="_blank"
                                        class="hover:underline"
                                    >
                                        Discord
                                ...
                                <li>
                                    <Link
                                        href="https://github.com/Virtualperadox/Peradox/blob/main/README.md"
                                        target="_blank"
                                        class="hover:underline"
                                    >
                                        Github
