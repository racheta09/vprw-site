    ...
    return (
        <div className="flex flex-col lg:flex-row items-stretch justify-between lg:px-0 px-6 lg:py-20 py-8 2xl:mx-auto 2xl:container">
            <div className="z-30 relative lg:w-1/2">
                <div className="hidden bg-[#F28322] w-full lg:w-10/12 lg:h-full lg:flex justify-end items-center">
                ...
                <div className="absolute top-0 bg-[#F28322] md:h-96 w-full hidden md:block lg:hidden"></div>
            ...
            <div className="bg-[#F24E29] lg:w-1/2 lg:ml-12 lg:p-14 p-8 flex items-center">
                <div>
                    <h1 className="md:w-8/12 lg:w-10/12 xl:8/12 2xl:w-8/12 w-full xl:text-6xl sm:text-5xl text-4xl font-semibold text-[#F2B90C] capitalize">
                        Welcome to the VIRTUAL PERADOX RACING WORLD
                    </h1>
                    <p className="md:w-9/12 lg:w-11/12 xl:w-10/12 2xl:9/12 text-base leading-normal text-[#F2B90C] mt-5">
                    ...
                    <Link href="#">
                        <button className="sm:w-auto w-full mt-8 text-base justify-between focus:ring-2 focus:ring-offset-2 focus:ring-[#F28322] focus:outline-none hover:bg-[#F2B90C] font-medium leading-none text-white py-4 px-8 bg-[#F28322] flex items-center">
                            Explore
